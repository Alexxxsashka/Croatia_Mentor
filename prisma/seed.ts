      ...
      sections: [
        {
          ...
          examples: [
            ...
            "on/ona/ono (he/she/it | on/ona/ono) — On je dobar. (He is good / Он хороший)",
  ...
  // A2 Communication
  {
    ...
    content: {
      description: {
        ...
        ua: "Потренуйтеся замовяти їжу та напої в хорватському ресторане."
      },
      sections: [
        {
          title: {
  ...
  // B2 Level Lesson 2
  {
    ...
    content: {
      description: {
        ...
        ua: "Вивчіть профессиональну лексику, ідіоми та навчіться розповідати про кар'єру хорватською."
      },
      sections: [
        {
          title: {
          ...
          text: {
            ...
            ru: "Обсуждение карьерного пути, professional целей и собеседований в Хорватии. Понятия: zapošljavanje (трудоустройство), životopis (резюме), razgovor za posao (собеседование), prekovremeni rad (сверхурочная работа).",
