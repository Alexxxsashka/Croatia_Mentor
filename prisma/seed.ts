...
async function main() {
  ...
  console.log("Seeding latest changelog v1.3.0...");
  await prisma.changelog.upsert({
    where: { id: "changelog-v1.3.0" },
    update: {
      version: "v1.3.0",
      titleUa: "🤖 Оновлений ІІ-чат, 4 режими навчання та адаптація світлої теми!",
...
• [b]Відкритий доступ до ІІ-чату для всіх[/b]: Вкладка «AI Чат» тепер доступна у головному меню для всіх користувачів та гостей!
• [b]4 спеціалізовані режими ІІ-наставника[/b]:
...
• [b]Строге дотримання тематики (Guardrails)[/b]: ІІ зосереджений виключно на вивченні хорватської мови та ввічливо відхиляє сторонні запити.
