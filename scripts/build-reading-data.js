...
Kada je sutradan izašao u dvorište, miris mokre zemlje i zrelog grožđa podsjetio ga je na dane nevinosti. U tom trenutku shvatio je da se u zavičaj ne vraća da bi pronašao ono što je izgubio, već da bi prihvatio ono što jest — slikar u potrazi za istinom u svijetu punom iluzija.`,
    vocabulary: [
      { hr: "izbivanje", en: "absence / stay away", ru: "отсутствие", ua: "відсутність" },
      { hr: "opčinjenost", en: "fascination / enchantment", ru: "очарование", ua: "зачарування" },
      { hr: "tjeskoba", en: "anxiety / anguish", ru: "тревога", ua: "тривога" },
      { hr: "zavičaj", en: "homeland / native region", ru: "родной край", ua: "рідний край" },
      { hr: "suzdržan", en: "reserved / restrained", ru: "сдержанный", ua: "стриманий" },
      { hr: "stvaralačka kriza", en: "creative crisis", ru: "творческий кризис", ua: "творча криза" },
      { hr: "voštane svijeće", en: "wax candles", ru: "восковые свечи", ua: "воскові свічки" },
      { hr: "raspadati se", en: "to fall apart", ru: "распадаться", ua: "розпадатися" },
      { hr: "glasine", en: "rumors", ru: "слухи", ua: "чутки" },
      { hr: "tekstura boje", en: "paint texture", ru: "текстура краски", ua: "текстура фарби" },
    ],
    questions: [
      {
        question: { en: "How many years was Filip absent from his hometown?", ru: "Сколько лет Филип отсутствовал в родном городе?", ua: "Скільки років Філіп був відсутній у рідному місті?" },
        options: ["Jedanaest godina (11 years)", "Pet godina (5 years)", "Dvadeset godina (20 years)", "Deset godina (10 years)"],
        correctAnswer: "Jedanaest godina (11 years)"
      },
      {
        question: { en: "What crisis was Filip experiencing as an artist?", ru: "Какой кризис переживал Филип как художник?", ua: "Яку кризу переживав Філіп як художник?" },
        options: ["Stvaralačku krizu (Creative crisis)", "Financijsku krizu (Financial crisis)", "Gubitak vida (Vision loss)", "Kvar na zrakoplovu (Airplane breakdown)"],
        correctAnswer: "Stvaralačku krizu (Creative crisis)"
      },
      {
        question: { en: "What is the name of Filip's mother?", ru: "Как зовут мать Филипа?", ua: "Як звати матір Філіпа?" },
        options: ["Regina", "Jelena", "Bobočka", "Mia"],
        correctAnswer: "Regina"
      },
      {
        question: { en: "Which famous landmark with wax candles did Filip pass?", ru: "Мимо какой достопримечательности с восковыми свечами прошел Филип?", ua: "Поздовж якої пам'ятки з восковими свічками пройшов Філіп?" },
        options: ["Kamenita vrata", "Kula Lotrščak", "Pazar", "Maksimir"],
        correctAnswer: "Kamenita vrata"
      },
      {
        question: { en: "What is the name of the mysterious woman in Kostanjevac?", ru: "Как зовут таинственную женщину в Костаньеваце?", ua: "Як звати таємничу жінку в Костаньєваці?" },
        options: ["Bobočka", "Ana", "Marija", "Regina"],
        correctAnswer: "Bobočka"
      }
    ],
    translationTasks: [
      { hr: "Poslije jedanaest godina izbivanja iz domovine", answer: { en: "After eleven years of absence from homeland", ru: "После одиннадцати лет отсутствия на родине", ua: "Після одинадцяти років відсутності на батьківщині" } },
      { hr: "Stvaralačka kriza i sjenke prošlosti", answer: { en: "Creative crisis and shadows of the past", ru: "Творческий кризис и тени прошлого", ua: "Творча криза та тіні минулого" } },
    ]
  },
  {
    id: "mali-princ",
...
Iskočio sam na noge kao da me pogodio grom. Dobro sam protrljao oči. Pogledao sam pažljivo. I vidio sam sasvim neobičnoga malog čovječuljka koji me ozbiljno promatrao. To je bio Mali Princ!`,
    vocabulary: [
      ...
      { hr: "plijen", en: "prey", ru: "добыча", ua: "здобич" },
      { hr: "probaviti", en: "to digest", ru: "переварить", ua: "перетравити" },
      { hr: "remek-djelo", en: "masterpiece", ru: "шедевр", ua: "шедевр" },
      { hr: "zrakoplov", en: "airplane", ru: "самолет", ua: "літак" },
      { hr: "zamorno", en: "tiring", ru: "утомительно", ua: "втомливо" },
      { hr: "pustinja", en: "desert", ru: "пустыня", ua: "пустеля" },
      { hr: "brodolomnik", en: "shipwreck survivor", ru: "выживший после кораблекрушения", ua: "потерпілий від трощі" },
    ],
    questions: [
      {
        question: { en: "What creature was the boa constrictor digesting in drawing number one?", ru: "Какое животное переваривал удав на рисунке номер один?", ua: "Яку тварину перетравлював удав на малюнку номер один?" },
        options: ["Afričkog slona (An African elephant)", "Lav (A lion)", "Konja (A horse)", "Ovcu (A sheep)"],
        correctAnswer: "Afričkog slona (An African elephant)"
      },
      {
        question: { en: "What strange request woke the narrator up in the Sahara desert at dawn?", ru: "С какой странной просьбой обратился голос на рассвете в пустыне?", ua: "З яким дивним проханням звернувся голос на світанку в пустелі?" },
        options: ["Nacrtaj mi ovcu! (Draw me a sheep!)", "Daj mi vode! (Give me water!)", "Popravi motor! (Fix the engine!)", "Pokaži mi kartu! (Show me the map!)"],
        correctAnswer: "Nacrtaj mi ovcu! (Draw me a sheep!)"
      }
    ],
    translationTasks: [
      { hr: "Molim te nacrtaj mi ovcu", answer: { en: "Please draw me a sheep", ru: "Пожалуйста нарисуй мне овечку", ua: "Будь ласка намалюй мені овечку" } }
    ]
  },
  {
...
Kada dođe vikend, obavezno odlazimo u istraživanje prirode i lokalnih običaja. Subotom ujutro posjećujemo poznatu splitsku tržnicu, zvanu Pazar, gdje kupujemo domaće maslinovo ulje, paški sir, smokve i svježe povrće. Odmah pokraj Pazara nalazi se Ribarnica (Peškarija), gdje kupujemo ribu koju su lokalni ribari ulovili u ranim jutarnjim satima. Poslijepodne često obiteljski šetamo stazama Marjana ili se opuštamo na plaži Bačvice. Zimi volimo kuhati tradicionalne dalmatinske specijalitete poput dalmatinske pašticade s njokima ili svježe ribe na žaru obogaćene ružmarinom i maslinovim uljem. Sretni smo što živimo u gradu gdje su priroda, sunce i obitelj uvek na prvom mjestu.`,
    vocabulary: [
      ...
      { hr: "ekosustav", en: "ecosystem", ru: "экосистема", ua: "екосистема" },
      { hr: "Ribarnica (Peškarija)", en: "fish market", ru: "рыбный рынок (Пешкария)", ua: "рибний ринок (Пешкарія)" },
      { hr: "pašticada", en: "Dalmatian beef stew", ru: "паштицада (далматинское рагу)", ua: "паштіцада (далматинське рагу)" },
    ],
    questions: [
      {
        question: { en: "What is the name of the famous Split fish market?", ru: "Как называется знаменитый рыбный рынок в Сплите?", ua: "Як називається знаменитий рибний ринок у Спліті?" },
        options: ["Peškarija (Fish market)", "Pazar", "Riva", "Marjan"],
        correctAnswer: "Peškarija (Fish market)"
      }
    ],
    translationTasks: [
      { hr: "Sunčana obala Jadranskog mora", answer: { en: "Sunny coast of Adriatic sea", ru: "Солнечный берег Адриатического моря", ua: "Сонячний берег Адріатичного моря" } }
    ]
  },
  {
...
Za posjetitelje iz svih krajeva svijeta uređeno je više od trideset kilometara drvenih staza koje vode tik iznad bistre vode u kojoj plivaju jata pastrva. Vožnja električnim brodom po najvećem jezeru Kozjak i panoramskim vlakom omogućuje posjetiteljima da dožive ljepotu parka bez zagađivanja okoliša. Plitvice su čarobne u svako doba godine: u proljeće zbog bujne zelene prirode i snažnih slapova, ljeti zbog ugodne svježine, u jesen zbog raskošnih boja šuma, a zimi kada se zaleđeni slapovi pretvore u bajkovite ledene skulpture.`,
    vocabulary: [
      { hr: "taloženje sedre", en: "tufa deposition", ru: "осаждение туфа", ua: "осадження туфу" },
...
Danas je Dubrovnik spomenik pod zaštitom UNESCO-a. Šetnja glavnom ulicom Stradunom, razgledavanje Kneževa dvora, palače Sponza i najstarije ljekarne u Europi unutar Franjevačkog samostana pruža posjetiteljima neponovljiv osjećaj povratka u zlatno doba renesanse i baroka.`,
    vocabulary: [
      { hr: "pomorska trgovina", en: "maritime trade", ru: "морская торговля", ua: "морська торгівля" },
      { hr: "libertas (sloboda)", en: "freedom / liberty", ru: "свобода", ua: "свобода" },
      { hr: "ukinuti ropstvo", en: "to abolish slavery", ru: "отменить рабство", ua: "скасувати рабство" },
      { hr: "Knežev dvor", en: "Rector's Palace", ru: "Княжеский дворец", ua: "Княжий палац" },
    ],
    questions: [
      {
        question: { en: "In which year did the Republic of Dubrovnik abolish slavery?", ru: "В каком году Дубровницкая республика отменила рабство?", ua: "У якому році Дубровницька республіка скасувала рабство?" },
        options: ["1416. godine", "1500. godine", "1600. godine", "1800. godine"],
        correctAnswer: "1416. godine"
      }
    ],
    translationTasks: [
      { hr: "Sloboda se ne prodaje ni za sve zlato svijeta", answer: { en: "Freedom is not sold for all the gold in the world", ru: "Свобода не продается ни за все золото мира", ua: "Свобода не продається ні за все золото світу" } }
    ]
  }
];

const fileContent = `export interface ReadingText {
  id: string;
...
export const readingTexts: ReadingText[] = ` + JSON.stringify(readingTexts, null, 2) + `;`;

fs.writeFileSync('src/lib/reading-data.ts', fileContent);
console.log('Successfully updated reading-data.ts with extended texts');
