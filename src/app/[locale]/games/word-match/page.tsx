...
export default function WordMatchPage() {
  ...
  const handleWin = () => {
    ...
    fetch("/api/progress", {
      ...
      body: JSON.stringify({ xp: earnedXP, wordsLearned: pairCount, wordsReviewed: pairCount }),
    }).catch(console.error);
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-xs font-semibold rounded-xl px-3 py-2 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-orange-500 cursor-pointer shadow-sm"
              >
            ...
            <div>
              ...
              >
                ...
                <option value="phrases" className="bg-white text-slate-900 dark:bg-slate-900 dark:text-slate-100">Phrases</option>
              </select>
            </div>
          </div>
