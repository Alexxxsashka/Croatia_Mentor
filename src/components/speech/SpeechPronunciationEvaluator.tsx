    ...
    <div className="glass rounded-2xl p-5 border border-white/10 space-y-4 my-4 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3.5 py-2.5 sm:px-3 sm:py-1.5 rounded-xl text-xs font-semibold glass hover:bg-white/10 transition-all min-h-[44px] sm:min-h-0 ${
