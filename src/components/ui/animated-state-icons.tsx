...
function useAutoToggle(interval: number, controlledState?: boolean) {
  ...
  }, [interval, controlledState]);

  return controlledState !== undefined ? controlledState : on;
}
...
export function SuccessIcon({
  ...
  const done = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      <motion.circle
        cx="20"
        cy="20"
        r="16"
...
export function MenuCloseIcon({
  ...
  const open = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      <motion.line
        x1="10"
...
export function PlayPauseIcon({
  ...
  const playing = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
...
export function LockUnlockIcon({
  ...
  const unlocked = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
...
export function CopiedIcon({
  ...
  const copied = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
...
export function NotificationIcon({
  ...
  const notif = useAutoToggle(duration, active ?? state);
  return (
    <motion.svg
      viewBox="0 0 40 40"
      fill="none"
...
export function HeartIcon({
  ...
  const filled = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      <motion.path
...
export function SendIcon({
  ...
  const sent = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      <motion.g
        animate={
...
export function ToggleIcon({
  ...
  const on = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      <motion.rect
        x="5"
...
export function EyeToggleIcon({
  ...
  const hidden = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      <motion.path
...
export function VolumeIcon({
  ...
  const muted = useAutoToggle(duration, active ?? state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("inline-block shrink-0", className)} style={{ width: size, height: size }}>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-8 justify-items-center">
        {ALL_ICONS.map(({ name, Icon }) => (
          <div key={name} className="flex flex-col items-center gap-3">
            <div className="flex items-center justify-center size-20 rounded-2xl border border-border bg-card shadow-sm">
              <Icon size={36} />
            </div>
