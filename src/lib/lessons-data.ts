...
export const lessonsData: LessonData[] = [
  // A1 Grammar
  {
    ...
    content: {
      description:
        "Learn the personal pronouns in Croatian — the building blocks of every sentence.",
      sections: [
        {
  ...
  // A1 Reading
  {
    ...
    content: {
      description:
        "Read a simple dialogue at a Croatian café and answer comprehension questions.",
      sections: [
        {
          title: "Dijalog",
  ...
  // A1 Dictation
  {
    ...
    content: {
      description:
        "Listen to basic Croatian greetings and type what you hear.",
  ...
  // A2 Grammar
  {
    ...
    content: {
      description:
        "Learn the accusative case in Croatian — used for direct objects.",
      sections: [
        {
  ...
  // A2 Communication
  {
    ...
    content: {
      description:
        "Practice ordering food and drinks at a Croatian restaurant.",
      sections: [
        {
  ...
  // B1 Grammar
  {
    ...
    content: {
      description:
        "Understand the perfective and imperfective verb aspects in Croatian.",
      sections: [
        {
