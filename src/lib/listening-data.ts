...
export const listeningData: ListeningItem[] = [
  ...
  },
  {
    ...
    description: {
      ...
      ua: "Класичний діалог із відомого хорватського фільму 'Tko pjeva zlo ne misli' (1970). Вивчайте дні тижня та ввічливу розмову."
    },
    subtitles: [
      { time: "0:00", hr: "Gospon Fulir: Gospođo Ana, vi ste nevjerojatni.", translation: { en: "Mr. Fulir: Mrs. Ana, you are incredible.", ru: "Господин Фулир: Госпожа Ана, вы невероятны.", ua: "Пан Фулір: Пані Ано, ви неймовірні." } },
      { time: "0:06", hr: "Gospon Fulir: Recite mi, kad se opet vidimo?", translation: { en: "Mr. Fulir: Tell me, when do we meet again?", ru: "Господин Фулир: Скажите мне, когда мы увидимся снова?", ua: "Пан Фулір: Скажіть мені, коли ми побачимося знову?" } },
      { time: "0:13", hr: "Ana: Pa... ne znam, gospon Fulir.", translation: { en: "Ana: Well... I don't know, Mr. Fulir.", ru: "Ана: Ну... я не знаю, господин Фулир.", ua: "Ана: Ну... я не знаю, пан Фулір." } },
      { time: "0:19", hr: "Gospon Fulir: Srijeda? Četvrtak?", translation: { en: "Mr. Fulir: Wednesday? Thursday?", ru: "Господин Фулир: Среда? Четверг?", ua: "Пан Фулір: Середа? Четвер?" } },
      { time: "0:24", hr: "Ana: Neka bude srijeda.", translation: { en: "Ana: Let it be Wednesday.", ru: "Ана: Пусть будет среда.", ua: "Ана: Нехай буде середа." } },
      { time: "0:28", hr: "Gospon Fulir: Divno, u šest kod kazališta.", translation: { en: "Mr. Fulir: Wonderful, at six by the theater.", ru: "Господин Фулир: Чудесно, в шесть у театра.", ua: "Пан Фулір: Чудово, о шостій біля театру." } }
    ],
    questions: [
      {
        question: { en: "Which day of the week did they choose to meet?", ru: "В какой день недели они решили встретиться?", ua: "У який день тижня вони вирішили зустрітися?" },
        options: ["Srijeda (Wednesday)", "Četvrtak (Thursday)", "Petak (Friday)", "Ponedjeljak (Monday)"],
        correctAnswer: "Srijeda (Wednesday)",
      },
      {
        question: { en: "Where are they meeting?", ru: "Где они встречаются?", ua: "Де вони зустрічаються?" },
        options: ["Kod kazališta (by the theater)", "U parku (in the park)", "Na trgu (in the square)", "U kafiću (in the cafe)"],
        correctAnswer: "Kod kazališta (by the theater)",
      },
      {
        question: { en: "What time are they meeting?", ru: "В какое время они встречаются?", ua: "О котрій годині вони зустрічаються?" },
        options: ["U šest (at six)", "U pet (at five)", "U sedam (at seven)", "U osam (at eight)"],
        correctAnswer: "U šest (at six)",
      }
    ],
    fillBlanks: [
      { sentence: "Srijeda? _____?", blank: "Četvrtak", hint: { en: "Thursday", ru: "Четверг", ua: "Четвер" } },
      { sentence: "Divno, u šest kod _____.", blank: "kazališta", hint: { en: "theater (genitive)", ru: "театра (род. п.)", ua: "театру (род. в.)" } }
    ]
  },
  {
    id: "razgovor-1",
    ...
    questions: [
      ...
      {
        question: { en: "What else did the customer buy?", ru: "Что ещё купил покупатель?", ua: "Что ещё купил покупатель?" },
